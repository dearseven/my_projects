...
public class DBClient extends SQLiteOpenHelper implements IDBClient {
    ...
    public List<Map<String, String>> retrieve(String tableName, String[] cols, String where, String[] cause, String group, String having, String order, String limit) {
        List<Map<String, String>> list = new ArrayList<Map<String, String>>();
        Cursor cs = null;
        SQLiteDatabase db = getReadableDb();
        try {
