 ...
 */
class BaseBLoCImpl<T extends BaseBLoC> extends StatefulWidget {
  BaseBLoCImpl({
    Key key,
    @required this.child,
    @required this.bloc,
...
class _BlocProviderState<T> extends State<BaseBLoCImpl<BaseBLoC>> {
  @override
  void dispose() {
    widget.bloc.dispose();
    super.dispose();
